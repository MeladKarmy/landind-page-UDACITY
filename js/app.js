...
// upButton variable
var upButton = document.querySelector("button");
// Header section
var navSection = document.querySelector(".page__header");
...
var scrollingUpdate = () => {
  ...
  for (const section of sections) {
    ...
    var topSpace = section.getBoundingClientRect().top;
    var anchor = document.querySelector(`a[href="#${section.getAttribute("id")}"]`);
...
var scrollingUp = (e) => {
 ...
 e.preventDefault();
 let offsetTop = navSection.offsetTop;
